...
const { addMovie, listMovies, updateMovie, deleteMovie } = require("./actor/actorMethods");
...
const app = async (args) =>{
    switch (process.argv[2]){
        ...
        break;
        case "filterTitle":
            filterMovie({title: args.title, actor: args.actor, rating: args.rating, year: args.year})
        break;
